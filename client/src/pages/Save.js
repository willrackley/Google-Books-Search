      ...
      render() {
        return (
            <div className="container">
                ...
                <div>
                    {this.state.savedBooks.length ? (<ul className="list-group ">
                                    ...
                                    <div className="row no-gutters text-center">
                                        <div className="col-12">
                                            <div className="card-footer text-muted">
                                                <div onClick={() => this.deleteBooks(books._id)}>
                    ...
                    </ul>) : (<h3 className="mt-5 text-center text-secondary">No Books Saved</h3>)}
